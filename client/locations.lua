...
Config.Locations = {
	{	job = "mechanic",
		zones = {
			vector2(-313.96194458008, -1376.2327880859),
			vector2(-313.94064331055, -1313.7513427734),
			vector2(-364.03521728516, -1313.962890625),
			vector2(-362.68347167969, -1375.8004150391)
		},
		autoClock = { enter = true, exit = true, },
		stash = { { coords = vec4(-340.81, -1332.03, 31.45, 70.0), w = 1.0, d = 2.2 }, },
		store = { { coords = vec4(-339.59, -1346.01, 31.53, 359.0), w = 1, d = 1 }, },
		crafting = { { coords = vec4(-328.28, -1368.33, 31.45, 32.25), w = 3.2, d = 1.0 }, },
		clockin = { { coords = vec4(-345.73, -1336.28, 31.45, 31.05), prop = false, }, },
		manualRepair = { { coords = vec4(-330.7611, -1339.8340, 31.4769, 177.3884), prop = true, } },
		garage = { spawn = vec4(-333.3591, -1374.6959, 31.4423, 191.60007),
					out = vec4(-333.3591, -1374.6959, 31.4423, 191.6000),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true, },
		payments = { coords = vec4(-346.4153, -1338.9330, 31.5538, 4.4282),
			...
			prop = true, },
		blip = vec3(-339.88, -1367.78, 31.51),
		bliplabel = "Mechanics",    -- Bennys Workshop next to PDM
		blipcolor = 1,
		discordlink = "",
