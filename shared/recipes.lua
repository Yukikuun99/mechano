...
Stores = {
	ToolItems = {
		...
		items = {
			...
			{ name = "ducttape", price = 500, amount = 100, info = {}, type = "item", },
			...
			{ name = "sparetire", price = 500, amount = 100, info = {}, type = "item", },
			{ name = "axleparts", price = 500, amount = 1000, info = {}, type = "item", },
			{ name = "carbattery", price = 500, amount = 1000, info = {}, type = "item", },
			{ name = "sparkplugs", price = 500, amount = 1000, info = {}, type = "item", },
			{ name = "newoil", price = 500, amount = 1000, info = {}, type = "item", },
		},
	},
	PerformItems = {
		label = Loc[Config.Lan]["stores"].perform,
		items = {
			{ name = "turbo", price = 40000, amount = 50, info = {}, type = "item", },
			{ name = "engine1", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "engine2", price = 10000, amount = 50, info = {}, type = "item", },
			{ name = "engine3", price = 13000, amount = 50, info = {}, type = "item", },
			{ name = "engine4", price = 16000, amount = 50, info = {}, type = "item", },
			{ name = "engine5", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "transmission1", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "transmission2", price = 11000, amount = 50, info = {}, type = "item", },
			{ name = "transmission3", price = 15000, amount = 50, info = {}, type = "item", },
			{ name = "transmission4", price = 19000, amount = 50, info = {}, type = "item", },
			{ name = "brakes1", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "brakes2", price = 12000, amount = 50, info = {}, type = "item", },
			{ name = "brakes3", price = 18000, amount = 50, info = {}, type = "item", },
			{ name = "car_armor", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "suspension1", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "suspension2", price = 10000, amount = 50, info = {}, type = "item", },
			{ name = "suspension3", price = 13000, amount = 50, info = {}, type = "item", },
			{ name = "suspension4", price = 16000, amount = 50, info = {}, type = "item", },
			{ name = "suspension5", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "nos", price = 100000, amount = 50, info = {}, type = "item", },
		},
	},
	StoreItems = {
